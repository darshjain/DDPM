...
class DatasetMildAug(Dataset):
    def __init__(self, folder, image_size, exts=['jpg', 'jpeg', 'png', 'tiff']):
        ...
        # EXPERIMENT 4: MILD AUGMENTATION
...
if __name__ == '__main__':
    ...
    trainer = Trainer(
        ...
        train_batch_size=64,
        train_lr=1e-4,          # Same as Exp 3
        train_num_steps=100000, # Same as Exp 3
        gradient_accumulate_every=1,
        ema_decay=0.995,
        amp=False,
        save_and_sample_every=4000,
        results_folder='./results_exp4_dim128', # EXPERIMENT 4 FOLDER
        num_samples=64,
        calculate_fid=False,
    )
