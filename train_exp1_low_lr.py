...
# ========== Augmented Dataset (No Augmentation for Exp 1) ==========
class DatasetNoAug(Dataset):
...
class MonitoredTrainer:
    ...
    def train(self):
        ...
        print(f"\n{'='*70}\n{'STARTING EXP 1: LOW LR + NO AUG':^70}\n{'='*70}")
...
if __name__ == '__main__':
    ...
    trainer = Trainer(
        ...
        train_batch_size=64,
        train_lr=2e-5,          # EXPERIMENT 1: LOW LEARNING RATE
        train_num_steps=100000, # EXPERIMENT 1: MORE STEPS
        gradient_accumulate_every=1,
        ema_decay=0.995,
        amp=False,
        save_and_sample_every=4000,
        results_folder='./results_exp1_low_lr_no_aug', # EXPERIMENT 1 FOLDER
        num_samples=64,
        calculate_fid=False,
    )

    print("Replacing dataset with DatasetNoAug...")
    ds = DatasetNoAug('./sysu-shape-dataset/combined/', 64)
